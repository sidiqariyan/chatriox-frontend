            ...
            <div>
              ...
              <div className="space-y-6">
                <p className={`text-lg leading-relaxed ${
                  ...
                  Founded in 2019, Chatriox emerged from a simple observation: businesses were struggling to reach their customers effectively in an increasingly digital world. Traditional marketing methods were becoming obsolete, and companies needed smarter, more efficient ways to connect.
                </p>
                <p className={`text-lg leading-relaxed ${
                  isDarkMode ? 'text-gray-300' : 'text-gray-600'
                }`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className={`text-xl max-w-3xl mx-auto ${
              ...
              The brilliant minds behind Chatriox's success
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div
                key={index}
                className={`p-8 rounded-3xl border backdrop-blur-lg transition-all duration-300 hover:scale-105 text-center ${
                  isDarkMode 
                    ? 'bg-white/5 border-white/10 hover:border-white/20' 
                    : 'bg-white/60 border-gray-200 hover:shadow-lg'
                }`}
              >
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-24 h-24 rounded-full mx-auto mb-6 object-cover ring-4 ring-white/20"
                />
                ...
                <p className={`text-sm font-medium mb-4 bg-gradient-to-r from-violet-500 via-blue-500 to-emerald-500 bg-clip-text text-transparent`}>
                  {member.role}
                </p>
                <p className={`text-sm leading-relaxed ${
                  isDarkMode ? 'text-gray-400' : 'text-gray-600'
