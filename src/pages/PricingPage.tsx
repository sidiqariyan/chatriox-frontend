...
const PricingPage: React.FC<PricingPageProps> = ({ isDarkMode }) => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we offer 7-day free trial with full access to all features. No credit card required.'
    },
    {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <button className={`px-12 py-6 rounded-2xl font-bold text-xl transition-all duration-300 hover:scale-105 backdrop-blur-xl border-2 ${
             ...
             <a href='https://calendly.com/ariyanvedive-com/30min'> Schedule Demo</a>
            </button>
          </div>
        </div>
      </section>
